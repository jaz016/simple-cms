    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <a href="blog_posts.php" class="btn btn-primary btn-sm" style="float:right;margin-top:20px"><i class="fa fa-arrow-left"></i> Go back to Add Post</a>
                        ...
                        <div class="well">
                            <div class="row">
                                ...
                                ?>
                                    ...
                                    <img src="<?php echo ROOT_DIR; ?>/uploads/<?php echo $post->get_image(); ?>" class="img-responsive" />
                                ...
                                <div class="col-sm-6">
                                    <h3><strong><?php echo $post->get_title(); ?></strong></h3>
                                    <p>
                                        <strong>Posted by:</strong> 
                                        <span class="author"><?php echo $post->get_author(); ?></span> @

                                        <i><?php echo $post->get_date_posted(); ?></i>
                                    </p>

                                    <p><?php echo $post->get_content(); ?></p>
                                    <button type="button" class="btn btn-danger btn-xs delete-content" data-content="blog-post" data-post-no="<?php echo $post->get_id(); ?>" style="position: absolute;top: 0;right: 15px;"><i class="fa fa-trash"></i> Delete</button>
                                </div>
                            </div>
                        </div>
